...
class AVLTree
{
    ...
    // to insert element to the AVL Tree
    ...
    // insert data in the AVL Tree recursively
    ...
    // perform double rotation of binary tree node.
    // first rotate the left child with its right child, and after that, node3 with the new left child
    ...
    // get total number of nodes in the AVL Tree
    ...
    // for traversing AVL Tree in in-order form
    ...
    // for traversing AVL Tree in pre-order form
    ...
    // for traversing AVL Tree in post-order form
